...
export async function mintAddon(
  ...
  const partialAddon: Partial<Addon> = {
    ...
    compatibleForms: template.compatibleForms,
    compatibleAnchors: template.compatibleAnchors,
    compatibleBodyShapes: template.compatibleBodyShapes,
    renderLayer: template.renderLayer,
    interactionProfile: template.interactionProfile,
    reactiveBehaviour: template.reactiveBehaviour,
    family: template.family,
    setId: template.setId,
    colourways: template.colourways,
    tryOnSupported: template.tryOnSupported,
    unlockMethod: template.unlockMethod,
    metadata: {
      ...template.metadata,
      createdAt: issuedAt,
