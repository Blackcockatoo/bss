...
const SCHOOLS_ALLOWED_EXACT = new Set([
  ...
  "/schools/parents",
  // Internal implementations backing the clean school-native URLs.
  "/schools/field",
  "/schools/lessons",
  "/schools/teacher-guide",
  "/schools/contact",
  // Clean, school-native public URLs (rewritten to internals by middleware).
  "/field",
  "/lessons",
  "/classroom",
  "/teacher-guide",
