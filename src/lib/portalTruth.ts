...
export const PORTAL_DESCRIPTION = IS_SCHOOLS_PROFILE
  ? "Teacher-led, time-bounded sessions for Years 3-6. No required student accounts or behavioural tracking; classroom state stays in the supervising adult's browser during routine use."
