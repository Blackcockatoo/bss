...
const AuraliaMetaPet: React.FC<AuraliaMetaPetProps> = ({
  ...
  useEffect(() => {
    ...
    const duration =
      eyeState.emotion === "surprised" || eyeState.emotion === "scared"
        ? 200
        : 500;
              ...
              >
                <defs>
                  ...
                  <radialGradient id="goldGlow">
                    <stop
                      offset="0%"
                      stopColor={currentForm.primaryGold}
                      stopOpacity="0.8"
                    />
                    <stop
                      offset="100%"
            ...
            {showAdvanced && (
              <>
                ...
                <div className="mt-6 text-center p-4 bg-gray-950/70 rounded-lg border border-yellow-600/30 backdrop-blur-sm shadow-lg">
                  <p
                    key={whisper.key}
                    className="text-base text-yellow-200 italic font-light leading-relaxed transition-opacity duration-500"
                  >
