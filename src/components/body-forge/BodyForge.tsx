...
export function BodyForge() {
  ...
  const sendToMetaPet = () => {
    ...
    // The Evolved form is the only renderer of the forged body — one
    // canonical constant, never a scattered string literal.
    setPetType(BODY_FORGE_RETURN_FORM);
          ...
          <div>
            ...
            {importedFromWorkshop && (
              <p className="mt-2 text-[10px] font-bold uppercase tracking-[0.16em] text-emerald-300">
                Standalone Forge packet loaded · review, then set inherited
                body
              </p>
            )}
          </div>
