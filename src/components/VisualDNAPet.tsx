        ...
        {showReadout && (
          <aside className="rounded-2xl border border-slate-800 bg-slate-950/72 p-4 text-sm text-zinc-300">
            ...
            <dl className="mt-4 space-y-2 text-xs">
              <div className="flex justify-between gap-3"><dt>Body source</dt><dd className={forgedBody ? 'text-amber-200' : 'text-cyan-200'}>{forgedBody ? 'Forge + live DNA' : '180-digit DNA'}</dd></div>
              <div className="flex justify-between gap-3"><dt>Visual genome</dt><dd className="max-w-[130px] truncate font-mono text-[10px] text-cyan-200" title={fingerprint}>{fingerprint}</dd></div>
