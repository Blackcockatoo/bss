...
/**
 * Lesson 5 — Feelings Without Words. A simplified emotion mixer (five primary
 * controls). Emotional states are temporary and are never saved to the real
 * pet. Language is deliberately non-absolute ("the pet may be feeling…").
 */
export function FeelingsActivity({
  ...
  if (step.kind === "observe") {
    return (
      <StepShell
        ...
        instruction="Select the clues you can see. Choose as many as you notice."
      >
  ...
  if (step.kind === "interact") {
    return (
      <StepShell
        ...
        instruction="Make a careful guess. Remember: we cannot be certain — it is okay to ask instead of assuming."
      >
        <div className="grid gap-6 lg:grid-cols-[16rem_1fr]">
          <div className="flex justify-center">
            <PetStage config={config} reducedMotion={reducedMotion} />
  ...
  if (step.kind === "discuss") {
    return (
      <StepShell
        ...
        instruction="Help the pet move toward calm. Change one or more signals, or guide it gently."
      >
        <div className="grid gap-6 lg:grid-cols-[16rem_1fr]">
  ...
  return (
    <StepShell
      ...
      instruction="Reflect on what you noticed and how you helped."
    >
