...
function AddonCard({
  ...
  return (
    <article
      className={`group flex h-full flex-col gap-2.5 rounded-2xl border ${styles.border} bg-gradient-to-b ${styles.glow} to-slate-900/80 p-3 shadow-lg shadow-black/20 transition hover:-translate-y-0.5 hover:border-white/20 sm:gap-3 sm:p-4`}
    >
      ...
      <div className="mt-auto pt-2">
        <span className="inline-flex rounded-lg border border-zinc-700 bg-zinc-900/70 px-2.5 py-1 text-[10px] text-zinc-400 sm:text-[11px]">
          {ctaLabel}
        </span>
      </div>
    </article>
        ...
        <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-500">
              IDs 1008–1036 · ready to mint and equip.
            </p>
          </div>
        </div>
