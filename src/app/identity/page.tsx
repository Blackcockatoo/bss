        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-2">
              Keep your contact details and avatar synced across QR messaging
              and pet profiles.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-6">
          <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-slate-500">
                  Max {Math.round(MAX_AVATAR_BYTES / 1024)} KB
                </span>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              {saveNotice && (
                <p
                  className={`text-xs ${hasErrors ? "text-rose-400" : "text-emerald-400"}`}
                >
                  {saveNotice}
                </p>
              )}
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  {form.email.trim() ||
                    "Add email to enable QR messaging identity"}
                </p>
              </div>
            </div>
            <div className="rounded-xl border border-slate-800 bg-slate-950/50 p-4 text-xs text-slate-400 space-y-2">
              <p>
                Your QR Messaging identity will default to your email address.
                If you leave the email blank, we will use your username instead.
              </p>
              <p>
                Last updated:{" "}
                {profile.updatedAt
              ...
              <p className="text-slate-600 border-t border-slate-800 pt-2 mt-2 leading-relaxed">
                Future vision: opt-in peer-to-peer identity verification using
                time-boxed consent grants — you choose who sees what, and for
                how long. No central authority required.
              </p>
            </div>
          </div>
        </div>
