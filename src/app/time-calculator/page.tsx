...
export default function TimeCalculatorPage() {
  enforceChildSafeServerRoute("/time-calculator");
      ...
      <div className="mx-auto flex w-full max-w-[1400px] flex-col gap-6">
        <header className="space-y-2">
          ...
          <h1 className="text-3xl font-bold md:text-4xl">
            MetaPet × Sacred Geometry Time Calculator
          </h1>
          <p className="max-w-4xl text-sm text-zinc-300 md:text-base">
            One coherent space: care for MetaPet, read its current vitals, and
            instantly map that state into the time calculator pattern presets.
          </p>
