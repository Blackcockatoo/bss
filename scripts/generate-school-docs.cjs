  ...
  return new Header({
    children: [
      new Paragraph({
        ...
        spacing: { after: 0 },
        children: [
          new TextRun({ text: "MetaPet School", font: "Calibri", size: 18, bold: true, color: NAVY }),
    ...
    children: [
      new Paragraph({
        ...
        children: [
          ...
          new TextRun({ text: "  |  MetaPet School  |  Confidential", font: "Calibri", size: 16, color: MID_GRAY }),
        ],
      }),
    ],
  });
  ...
  return new Document({
    ...
    sections: [{
      ...
      children: [
        ...
        h2("What Is This?"),
        p("MetaPet School is a short teacher-led classroom activity for Years 3\u20136. Students use a digital companion to notice patterns, practise simple online safety habits, and talk about systems and regulation in age-appropriate language."),
        spacer(),
  ...
  return new Document({
    ...
    sections: [{
      ...
      children: [
        ...
        spacer(),
        ...sessionCard(1, "Meet the System",
          "Students identify an input and explain one visible state change it caused.",
          "Observe a starting state, apply one input, and explain the visible change.",
          "What was the input, what changed, and what evidence can we see?",
          "Optional teacher tick: identified input, state, and output.",
          "Digital Technologies mini-lesson"),
        ...sessionCard(2, "Read the Signals",
          "Students identify a signal, choose a response, and give a reason.",
          "Find visible signals, choose a calm reversible response, and check the result.",
          "Which signal supports your choice, and what else could it mean?",
          "Optional alias-only note of signal, response, and result.",
          "Digital Technologies mini-lesson"),
        ...sessionCard(3, "One Identity, Many Representations",
          "Students match representations and explain what stays the same.",
          "Inspect visual, numeric, and trait views; match the shared identity; compare what each view reveals.",
          "What stayed the same, and what changed only in the display?",
          "Optional photo-free note of the chosen representation and reason.",
          "Digital Technologies or Mathematics mini-lesson"),
        ...sessionCard(4, "Choices and Algorithms",
          "Students order choices, test the result, and repair one problem.",
          "Build a sequence, run it, then add a branch, repeat, or repair.",
          "Where did the sequence differ from what you intended?",
          "Optional saved or paper sequence with one repair note.",
          "Digital Technologies or STEM block"),
        ...sessionCard(5, "Privacy and Responsible Design",
          "Students explain why a system should collect less information and give people meaningful control.",
          "Identify unnecessary data, redesign a choice, and explain the safer alternative.",
          "What information is actually needed, and who can delete it?",
          "Optional data-minimisation decision and reason.",
          "Digital Technologies or online safety lesson"),
        ...sessionCard(6, "Design a Better Feature",
          "Students propose a feature and explain one safety or accessibility decision.",
          "Find a user need, sketch a small feature, and inspect its accessibility, privacy, and wellbeing boundaries.",
          "Who does this help, and what pressure or excess data did you remove?",
          "Optional feature sketch or teacher observation note.",
          "Design and Technologies or STEM block"),
        ...sessionCard(7, "Test, Reflect and Improve",
          "Students describe what they tested, what they learned, and one improvement they made.",
          "Choose a criterion, run a small test, accept feedback, and revise the design.",
          "What changed because of the evidence rather than preference?",
          "Optional before-and-after explanation; no marking required.",
          "STEM block or end-of-sequence reflection"),
        h2("Suggested Sequence Options"),
        boldP("Full sequence: ", "Use Lessons 1\u20137 in order."),
        boldP("Short systems sequence: ", "Use Lessons 1, 2, 4 and 7."),
        boldP("Short responsible-design sequence: ", "Use Lessons 1, 3, 5, 6 and 7."),
        boldP("Low-prep entry: ", "Use Lesson 1 as the standalone starting point."),
      ],
    }],
  });
}
