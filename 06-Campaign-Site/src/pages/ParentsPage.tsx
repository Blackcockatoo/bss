    ...
    <CampaignLayout>
          ...
          <div style={{ background: "#111f3a", borderRadius: "20px", border: "1px solid rgba(245,200,76,.2)", padding: "24px" }}>
            ...
            {[
              ...
              <div key={i} style={{ display: "flex", gap: "10px", marginBottom: "10px", alignItems: "flex-start" }}>
                ...
                <span style={{ color: "#7a8da8", fontSize: "14px", lineHeight: 1.5 }}>{item}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: "14px" }}>
          {[
            ...
            <div key={i} style={{ background: "#111f3a", border: "1px solid rgba(167,139,250,.2)", borderRadius: "14px", padding: "20px" }}>
              ...
              <p style={{ color: "#7a8da8", fontSize: "13px", lineHeight: 1.65 }}>{faq.a}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ maxWidth: "700px", margin: "0 auto 100px", padding: "0 18px", textAlign: "center" }}>
        ...
        <p style={{ color: "#7a8da8", lineHeight: 1.7, marginBottom: "24px" }}>
          Talk to your child's teacher. They have a complete FAQ response template and the full privacy brief.
